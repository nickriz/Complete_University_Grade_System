...
<body>
  ...
  <div class="page-content content-photo p-4" id="content">
    ...
    <div class="col-lg-12">
      <h3 class="mathimata">Επεξεργασία Φοιτητών</h3><br>
      <form action="diaxeirisi_foititon.php?task=edit&student_id=<?php echo $student_id;?>" method="post">
        <?php
...
while($row = $result->fetch_assoc()){
  ?>
        <div class="form-group row">
          <label class="col-2 col-form-label" for="InputID">ID Φοιτητή: </label>
          <input type="text" class="col-4 form-control" id="InputID" name="InputID" value="<?php echo $row['student_id'];?>">
        </div>
    <div class="form-group row">
		...
		<div class="form-group row">
          <label class="col-2 col-form-label" for="InputLast">Επώνυμο Φοιτητή: </label>
