...
$student_id_old =$_GET['student_id'];
$student_id =$_POST['InputID'];
...
$sqlup = "UPDATE students
        	 SET student_id='$student_id', password='$password', first_name='$first_name',last_name='$last_name',email='$email'
...
<body>
  ...
  <div class="page-content content-photo p-4" id="content">
    ...
    <div class="col-lg-12">
      <h3 id="mathimata">Φοιτητές</h3></h3><br>
        ...
        <tbody>
              ...
              <?php
                ...
                if ($link->connect_error) {
                  ...
                  $sql = "SELECT s.student_id, s.first_name, s.last_name, s.password, s.email
                        FROM students s";
                    ...
                    <tr>
                        ...
                        <th scope="row">
                          <a href="edit_students.php?task=edit&student_id=<?php echo $row['student_id']; ?>">Edit</a>
                          <a href="diaxeirisi_foititon.php?task=delete&student_id=<?php echo $row['student_id'];?>">Delete</a>
